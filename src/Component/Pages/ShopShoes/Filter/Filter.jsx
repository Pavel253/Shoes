...
const Filter = ({ priceMax, priceMin, setGenderFilter, setColorFilter, setSizeFilter, setPriceFilterMax, setPriceFilterMin, setGenderClick, colorFilter }) => {
  ...
  const color = [{ id: 1, color: "Black" }, { id: 2, color: "White" }, { id: 3, color: "Green" }, { id: 4, color: "Red" }, { id: 5, color: "Purple" }, { id: 6, color: "Pink" }, { id: 7, color: "Yellow" }, { id: 8, color: "Orange" }, { id: 9, color: "Blue" }]
